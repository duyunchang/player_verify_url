package com.lance.net.server.util.sign;
...
public class Sign {
    ...
    public static void main(String[] args) throws InvalidKeyException, NoSuchAlgorithmException, UnsupportedEncodingException {
    	 String substring = MD5.stringToMD5("e8RYTBh071jU8asyrCNL7sTu9KMCptul"+"2407_test_ddd"+1489503600);
    	 System.out.println(substring);
//    	String time="2017-03-14 23:00:00";
//    	String sign = sign("1489503600", "e8RYTBh071jU8asyrCNL7sTu9KMCptul");
